#!/bin/bash 
#SBATCH --job-name=exp_srdiff_test_inference_joint_srdiff_lcc_maxvit_hr5_convformer_sr4_caf_focal_all
...
#SBATCH --output logs/exp_srdiff_test_inference_joint_srdiff_lcc_maxvit_hr5_convformer_sr4_caf_focal_all_%j.out
#SBATCH --error logs/exp_srdiff_test_inference_joint_srdiff_lcc_maxvit_hr5_convformer_sr4_caf_focal_all_%j.err
